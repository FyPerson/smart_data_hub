...
app.post('/api/corrections', authenticateToken, requireCorrectionSchemaReady, requireAdmin, async (req, res) => {
    try {
        const b = req.body || {};
...
app.post('/api/corrections/:id/assign', authenticateToken, requireCorrectionSchemaReady, requirePublisherOrAdmin, async (req, res) => {
...
app.get('/api/corrections', authenticateToken, requireCorrectionSchemaReady, async (req, res) => {
    try {
...
app.get('/api/corrections/:id', authenticateToken, requireCorrectionSchemaReady, async (req, res) => {
    const id = Number(req.params.id);
    if (!Number.isInteger(id) || id <= 0) return res.status(400).json({ error: '无效的修正单 ID', code: 'INVALID_CORRECTION_ID' });   // codex 09 L-6
    try {
...
app.post('/api/corrections/:id/reply-estimate', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, async (req, res) => {
    try {
        const id = parseInt(req.params.id, 10);
...
app.post('/api/corrections/:id/complete', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, correctionUploadMw('files', 5), async (req, res) => {
    const id = parseInt(req.params.id, 10);
    let persisted = [];
    try {
...
app.post('/api/corrections/:id/resubmit', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, correctionUploadMw('files', 5), async (req, res) => {
    const id = parseInt(req.params.id, 10);
    let persisted = [];
    try {
        const row = await dbGetAsync('SELECT id, status, correction_type, assigned_to FROM correction_requests WHERE id = ?', [id]);
...
app.post('/api/corrections/:id/attachments', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, correctionUploadMw('files', 5), async (req, res) => {
    const id = parseInt(req.params.id, 10);
...
app.post('/api/corrections/:id/reject', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, async (req, res) => {
    try {
        const id = parseInt(req.params.id, 10);
...
app.post('/api/corrections/:id/archive', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, async (req, res) => {
    try {
        const id = parseInt(req.params.id, 10);
...
app.post('/api/corrections/:id/admin-close', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, requireAdmin, async (req, res) => {
    try {
        const id = parseInt(req.params.id, 10);
...
app.post('/api/corrections/:id/void', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, async (req, res) => {
    try {
        const id = parseInt(req.params.id, 10);
...
app.post('/api/corrections/:id/notify-done', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, async (req, res) => {
    const id = parseInt(req.params.id, 10);
    const userId = Number(req.user.id);
    const userName = req.user.display_name || req.user.username || `user#${userId}`;
    const isAdmin = req.user.role === 'admin';
...
app.post('/api/corrections/:id/notify-developer', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, requirePublisherOrAdmin, async (req, res) => {
    const id = parseInt(req.params.id, 10);
    try {
...
app.post('/api/corrections/:id/notify-relay', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, requireAdmin, async (req, res) => {
    const id = parseInt(req.params.id, 10);
    try {
...
app.post('/api/corrections/:id/notify-estimate', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, async (req, res) => {
    const id = parseInt(req.params.id, 10);
    try {
...
app.get('/api/corrections/:id/notify-read-status', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, async (req, res) => {
    const id = parseInt(req.params.id, 10);
    try {
...
app.post('/api/corrections/:id/create-chat', authenticateToken, requireCorrectionSchemaReady, correctionIdGuard, async (req, res) => {
    const id = parseInt(req.params.id, 10);
    const userId = Number(req.user.id);
    const userName = req.user.display_name || req.user.username || `user#${userId}`;
    const role = req.user.role;
